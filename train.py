...
argparser.add_argument(
    '-d', '--data', default=None, help="path to h5_data: images and labels")
...
def _main_(args):
    ...
    yolo.train(train_imgs                   = train_imgs,
               ...
               learning_rate_decay_patience = config['train']['learning_rate_decay_patience'],
...
def _main_h5(args):
    ...
    # yolo.load_weights("/home/cheng/Desktop/repos/keras-yolo2/snapshots/latest_all_shovel_full_yolo/full_yolo_34.h5")
